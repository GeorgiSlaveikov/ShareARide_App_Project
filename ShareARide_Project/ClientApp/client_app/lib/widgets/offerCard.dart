...
//     //     ? departureCity
//     //     : City.fromJson(City.from(departureCity));
...
//               children: [
//                 const Text("Колко човевка пътуват?"),
...
//                 final DateTime departureTime = DateTime.parse(offer.departureTime.toString());
...
//                     const SnackBar(
//                       content: Text(
//                         "Booking successful! Reminder notification scheduled.",
//                       ),
